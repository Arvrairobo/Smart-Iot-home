...
cap = cv2.VideoCapture("/home/kush/On The Quest To Invisibility - Metamaterials and Cloaking - Andrea Alu at TEDxAustin-jseHPnqXlPY.mp4")
face_cascade = cv2.CascadeClassifier("/home/kush/opencv-3.1.0/data/haarcascades/haarcascade_frontalface_alt.xml")
...
gavg=0
while True:
    tval1 = cv2.getTrackbarPos('tval', 'Video')
