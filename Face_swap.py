...
parser.add_argument("-i","--img",
                    help="Give Path of image with to face")
args = parser.parse_args()
PREDICTOR_PATH = "/home/kush/shape_predictor_68_face_landmarks.dat"
SCALE_FACTOR = 1
FEATHER_AMOUNT = 11
...
def get_landmarks(im):
    rects = cv2.cascade.detectMultiScale(im, 1.3, 5)
    # if len(rects) > 1:
    #    raise TooManyFaces
    if len(rects) == 0:
        raise NoFaces
...
im, lndmL = read_im_and_landmarks(args.img)
l1 = lndmL[0]
l2 = lndmL[1]
res = im.copy()
...
cv2.imwrite('/home/kush/Desktop/result.jpg', res)